...
public class SiteCarte extends HBox {
  ...
  public SiteCarte() {
    ...
    try {
      ...
      throw new RuntimeException("Impossible de charger le FXML de SiteCarte", e);
    }
  }
  ...
  private void initialize() {
    ...
    labelBadge.getStyleClass().add("badge");
    labelCarre.getStyleClass().add("carre-no");
    labelNom.getStyleClass().add("carre-nom");
